...
% Set directory
cd 'C:\Democritus University of Thrace (DUTh)\OneDrive\facial_blood_flow_recognition\';
...
for i=1:day_len
    ...
    for j=1:person_len
        ...
        for k=3:length(files)
            ...
            % Forehead
            out_vfilename = [out_video_path 'Right_Cheeck\' day_subfolders(i, :) person_subfolders(j, :) name] 
